 ...
 * activity.**
 */
class ViewPersonActivityAdmin : AppCompatActivity() {
    ...
    private fun setupLayout() {
        val personImage = IOUtils.readPersonImageWithDefault(person.id, applicationContext)
        ...
        button.setOnClickListener {
            ...
            val intent = Intent(this, TreeActivityAdmin::class.java)
                    .putExtra(TreeActivityAdmin.EXTRA_PERSON, treeRoot)
                    .putExtra(TreeActivityAdmin.EXTRA_NAME, person.forename)
    ...
    private fun setupParentsList() {
        ...
        val personAdapter = PersonAdapterAdmin(parents)
    ...
    private fun setupMarriagesList() {
        ...
        val personAdapter = MarriageAdapterAdmin(this, person.id, marriages)
        ...
        when (item!!.itemId) {
            ...
            R.id.action_edit -> {
                val intent = Intent(this, EditPersonActivityAdmin::class.java)
                        .putExtra(EditPersonActivityAdmin.EXTRA_PERSON, person)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_PERSON_EDIT -> if (resultCode == Activity.RESULT_OK) {
                ...
                person = data!!.getParcelableExtra(EditPersonActivityAdmin.EXTRA_PERSON)
