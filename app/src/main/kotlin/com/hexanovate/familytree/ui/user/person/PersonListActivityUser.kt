 ...
 */
class PersonListActivityUser : NavigationDrawerActivity() {
    ...
    private lateinit var personAdapter: PersonAdapterUser

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(withNavigation(R.layout.activity_list_user))
...
//    }
    ...
    private fun populateList() {
        ...
        personAdapter = PersonAdapterUser(people)
