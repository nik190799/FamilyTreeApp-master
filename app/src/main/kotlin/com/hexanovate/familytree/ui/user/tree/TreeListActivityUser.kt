 ...
 * @see TreeActivity
 */
class TreeListActivityUser : NavigationDrawerActivity() {
    ...
    private lateinit var treeAdapter: FamilyTreeAdapterUser
    ...
    private fun populateList() {
        val root = TreeHandlerUser.getDisplayedTree(this, null)
        items = root?.asTreeList() as ArrayList<TreeListItem<Person>>

        treeAdapter = FamilyTreeAdapterUser(this, items)
    ...
    private fun refreshList() {
        items.clear()
        val newRoot = TreeHandlerUser.getDisplayedTree(this, null)
