...
class ViewTreeTile(context: Context, onClick: OnClick) : HomeTileUser(
...
class PeopleTile(context: Context, peopleCount: Int, onClick: OnClick) : HomeTileUser(
...
class EventsTile(context: Context, onClick: OnClick) : HomeTileUser(
...
//class AddPersonTile(context: Context, onClick: OnClick) : HomeTileUser(
