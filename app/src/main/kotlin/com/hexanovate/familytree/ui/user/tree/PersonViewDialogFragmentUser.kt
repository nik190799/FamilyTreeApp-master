 ...
 * from a [com.hexanovate.familytree.ui.widget.TreeView].
 *
 * @see TreeActivity
 */
class PersonViewDialogFragmentUser : DialogFragment() {
    ...
    companion object {
        ...
        ): PersonViewDialogFragmentUser {
            val fragment = PersonViewDialogFragmentUser()
    ...
    private fun invokeDialogAction(which: Int) = when (which) {
        ...
        in 1..(1 + switchTreeOptions.count()) -> {
            val chosenPerson = switchTreeOptions[which - 1]
