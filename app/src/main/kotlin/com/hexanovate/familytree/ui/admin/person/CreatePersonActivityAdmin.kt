...
import com.hexanovate.familytree.ui.admin.DynamicPagerAdapterAdmin
 ...
 */
class CreatePersonActivityAdmin : AppCompatActivity() {
    ...
    private val pagerAdapter = DynamicPagerAdapterAdmin()
    ...
    private fun getCreatorClass(index: Int) = when (index) {
        ...
        1 -> {
            marriageCreator = PersonMarriageCreator(this, person!!) { _, _ ->
                val intent = Intent(this, EditMarriageActivityAdmin::class.java)
