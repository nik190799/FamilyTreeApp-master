...
package com.hexanovate.familytree.ui.admin.event
...
import com.hexanovate.familytree.ui.admin.marriage.ViewMarriageActivityAdmin
 ...
 */
class EventsActivityAdmin : NavigationDrawerActivity() {
    ...
    private val eventHandler = EventHandlerAdmin(this)
    private lateinit var events: ArrayList<Event>

    private lateinit var eventAdapter: EventAdapterAdmin
    ...
    private fun populateList() {
        ...
        eventAdapter = EventAdapterAdmin(this, events)
    ...
    private fun viewEvent(event: Event) = when (event) {
        is Anniversary -> {
            ...
            val intent = Intent(this, ViewMarriageActivityAdmin::class.java)
                    .putExtra(ViewMarriageActivityAdmin.EXTRA_MARRIAGE, marriage)
