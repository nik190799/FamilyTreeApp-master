...
import com.hexanovate.familytree.ui.user.person.PersonAdapterUser
 ...
 */
class PersonSelectorHelperUser(
    ...
    private fun createPersonSelector(dialog: AlertDialog): RecyclerView {
        val personAdapter = PersonAdapterUser(PersonManager(context).getAll())
