 ...
 * calling activity.**
 */
class ViewMarriageActivityAdmin : AppCompatActivity() {
        ...
        when (item!!.itemId) {
            ...
            R.id.action_edit -> {
                val intent = Intent(this, EditMarriageActivityAdmin::class.java)
                        .putExtra(EditMarriageActivityAdmin.EXTRA_MARRIAGE, marriage)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_MARRIAGE_EDIT -> if (resultCode == Activity.RESULT_OK) {
                ...
                marriage = data!!.getParcelableExtra(EditMarriageActivityAdmin.EXTRA_MARRIAGE)
