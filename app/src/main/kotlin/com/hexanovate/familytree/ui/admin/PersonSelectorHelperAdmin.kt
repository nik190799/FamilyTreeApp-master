...
package com.hexanovate.familytree.ui.admin
...
import com.hexanovate.familytree.ui.admin.person.PersonAdapterAdmin
 ...
 */
class PersonSelectorHelperAdmin(
    ...
    private fun createPersonSelector(dialog: AlertDialog): RecyclerView {
        val personAdapter = PersonAdapterAdmin(PersonManager(context).getAll())
