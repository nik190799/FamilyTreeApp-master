...
import com.hexanovate.familytree.ui.widget.TreeView
...
class TreeHandlerAdmin(
     ...
     */
    fun getDisplayedTree(person: Person?) = TreeHandlerAdmin.getDisplayedTree(context, person)
