 ...
 */
interface PersonCreatorSectionAdmin {
...
class PersonDetailsCreator(
    ...
    private fun createDatesCard(layoutInflater: LayoutInflater, container: ViewGroup): View {
        ...
        datesSelectorHelper = DateRangeSelectorHelperAdmin(
                DateSelectorHelperAdmin(context, card.findViewById(R.id.editText_dateOfBirth)),
                DateSelectorHelperAdmin(context, card.findViewById(R.id.editText_dateOfDeath))
        )
...
class PersonMarriageCreator(
    ...
    private fun setupMarriageList() {
        ...
        val marriageAdapter = MarriageAdapterAdmin(context, person.id, marriages)
