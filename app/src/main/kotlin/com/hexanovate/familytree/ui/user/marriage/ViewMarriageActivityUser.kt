 ...
 * calling activity.**
 */
class ViewMarriageActivityUser : AppCompatActivity() {
...
//                        .putExtra(EditMarriageActivityUser.EXTRA_MARRIAGE, marriage)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_MARRIAGE_EDIT -> if (resultCode == Activity.RESULT_OK) {
                ...
                marriage = data!!.getParcelableExtra(EditMarriageActivityUser.EXTRA_MARRIAGE)
