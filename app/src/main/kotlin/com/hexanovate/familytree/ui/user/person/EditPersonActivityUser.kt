 ...
 */
class EditPersonActivityUser : AppCompatActivity() {
    ...
    private fun assignUiComponents() {
        ...
        marriageRecyclerView = findViewById<RecyclerView>(R.id.recyclerView_marriages).apply {
            ...
            layoutManager = LinearLayoutManager(this@EditPersonActivityUser)
        }
    ...
    private fun setupDatePickers() {
        val dateOfBirthHelper = DateSelectorHelperUser(this, findViewById(R.id.editText_dateOfBirth))
        val dateOfDeathHelper = DateSelectorHelperUser(this, findViewById(R.id.editText_dateOfDeath))
        datesSelectorHelper = DateRangeSelectorHelperUser(dateOfBirthHelper, dateOfDeathHelper)
    }
    ...
    private fun setupMarriageList() {
        ...
        val marriageAdapter = MarriageAdapterUser(this, person.id, marriages)
    ...
    private fun chooseChildDialog() {
        ...
        builder.setView(recyclerView)
                ...
                .setPositiveButton(R.string.action_create_new) { _, _ ->
                    val intent = Intent(this, EditPersonActivityUser::class.java)
    ...
    private fun chooseMarriageDialog() {
        ...
        val marriageAdapter = MarriageAdapterUser(this, person.id, potentialMarriages)
        marriageAdapter.onItemClick { _, marriage ->
        ...
        builder.setView(recyclerView)
                ...
                .setPositiveButton(R.string.action_create_new) { _, _ ->
                    val intent = Intent(this@EditPersonActivityUser, EditMarriageActivityUser::class.java)
                            .putExtra(EditMarriageActivityUser.EXTRA_WRITE_DATA, false)
