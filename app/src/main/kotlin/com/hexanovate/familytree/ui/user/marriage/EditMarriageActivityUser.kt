...
package com.hexanovate.familytree.ui.user.marriage
...
import com.hexanovate.familytree.ui.user.PersonSelectorHelperUser
 ...
 */
class EditMarriageActivityUser : AppCompatActivity() {
    ...
    private lateinit var person1Selector: PersonSelectorHelperUser
    private lateinit var person2Selector: PersonSelectorHelperUser
    ...
    private fun assignUiComponents() {
        person1Selector = PersonSelectorHelperUser(this, findViewById(R.id.editText_person1)).apply {
            onCreateNewPerson = { _, _ ->
                val intent = Intent(this@EditMarriageActivityUser, CreatePersonActivityUser::class.java)
                startActivityForResult(intent, REQUEST_CREATE_PERSON_1)
            }
        }
        person2Selector = PersonSelectorHelperUser(this, findViewById(R.id.editText_person2)).apply {
            onCreateNewPerson = { _, _ ->
                val intent = Intent(this@EditMarriageActivityUser, CreatePersonActivityUser::class.java)
    ...
    private fun initDatePickers() {
        val startDateHelper = DateSelectorHelperUser(this, findViewById(R.id.editText_startDate))
        val endDateHelper = DateSelectorHelperUser(this, findViewById(R.id.editText_endDate))
        datesSelectorHelper = DateRangeSelectorHelperUser(startDateHelper, endDateHelper)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_CREATE_PERSON_1 -> if (resultCode == Activity.RESULT_OK) {
                val newPerson1 = data!!.getParcelableExtra<Person>(CreatePersonActivityUser.EXTRA_PERSON)
                person1Selector.person = newPerson1
            }
            REQUEST_CREATE_PERSON_2 -> if (resultCode == Activity.RESULT_OK) {
                val newPerson2 = data!!.getParcelableExtra<Person>(CreatePersonActivityUser.EXTRA_PERSON)
