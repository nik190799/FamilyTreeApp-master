 ...
 * activity.**
 */
class ViewPersonActivityUser : AppCompatActivity() {
    ...
    private fun setupLayout() {
        ...
        button.setOnClickListener {
            ...
            val intent = Intent(this, TreeActivityUser::class.java)
                    .putExtra(TreeActivityUser.EXTRA_PERSON, treeRoot)
                    .putExtra(TreeActivityUser.EXTRA_NAME, person.forename)
    ...
    private fun setupParentsList() {
        ...
        val personAdapter = PersonAdapterUser(parents)
    ...
    private fun setupMarriagesList() {
        ...
        val personAdapter = MarriageAdapterUser(this, person.id, marriages)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        menuInflater.inflate(R.menu.menu_view_detail_user, menu)
        return true
    }
...
//                        .putExtra(EditPersonActivityUser.EXTRA_PERSON, person)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            REQUEST_PERSON_EDIT -> if (resultCode == Activity.RESULT_OK) {
                ...
                person = data!!.getParcelableExtra(EditPersonActivityUser.EXTRA_PERSON)
