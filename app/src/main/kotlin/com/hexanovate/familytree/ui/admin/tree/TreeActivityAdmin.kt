...
import com.hexanovate.familytree.ui.admin.person.ViewPersonActivityAdmin
 ...
 */
class TreeActivityAdmin : NavigationDrawerActivity(), PersonViewDialogFragmentAdmin.OnDialogActionChosenListener {
     ...
     */
    private lateinit var treeHandler: TreeHandlerAdmin
    ...
    private fun initTreeHandler() {
        ...
        treeHandler = TreeHandlerAdmin(this, treeContainer) { _, person ->
            selectedPersonCache = person
            val dialogFragment = PersonViewDialogFragmentAdmin.newInstance(person, this)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            ...
            REQUEST_ADD_PARENT -> if (resultCode == Activity.RESULT_OK) {
                val parent = data?.getParcelableExtra<Person>(CreatePersonActivityAdmin.EXTRA_PERSON)
                if (parent != null) {
