...
class ViewTreeTile(context: Context, onClick: OnClick) : HomeTileAdmin(
...
class PeopleTile(context: Context, peopleCount: Int, onClick: OnClick) : HomeTileAdmin(
...
class EventsTile(context: Context, onClick: OnClick) : HomeTileAdmin(
...
class AddPersonTile(context: Context, onClick: OnClick) : HomeTileAdmin(
